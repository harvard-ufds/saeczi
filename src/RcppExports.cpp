...
// dom_preds_calc
SEXP dom_preds_calc(const Eigen::MatrixXd& beta_lm, const Eigen::MatrixXd& beta_glm, const Rcpp::CharacterVector& names, const Rcpp::CharacterVector& dom_input, const Rcpp::List& u, const Eigen::MatrixXd& design_mat_lm, const Eigen::MatrixXd& design_mat_glm);
RcppExport SEXP _saeczi_dom_preds_calc(SEXP beta_lmSEXP, SEXP beta_glmSEXP, SEXP namesSEXP, SEXP dom_inputSEXP, SEXP uSEXP, SEXP design_mat_lmSEXP, SEXP design_mat_glmSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(dom_preds_calc(beta_lm, beta_glm, names, dom_input, u, design_mat_lm, design_mat_glm));
    return rcpp_result_gen;
END_RCPP
}

static const R_CallMethodDef CallEntries[] = {
    {"_saeczi_dom_preds_calc", (DL_FUNC) &_saeczi_dom_preds_calc, 7},
    {NULL, NULL, 0}
};
